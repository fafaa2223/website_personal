            ...
            <div class="row d_flex">
               <div class="col-md-6">
                  <div class="titlepage text_align_left">
                     <h2>About Us</h2>
                     <p>Teh Botol Sosro adalah minuman teh siap saji pertama di Indonesia, diluncurkan pada tahun 1969. Diproduksi oleh PT. Sinar Sosro, kami menggunakan daun teh berkualitas untuk memberikan rasa segar yang unik. Dengan inovasi dalam kemasan, kami hadir untuk menyegarkan setiap momen Anda, kapan saja dan di mana saja.
                     </p>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="about_img text_align_center">
                     <figure><img class="img_responsive" src="images/Rectangle 29.png" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
